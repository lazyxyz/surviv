...
export class Actor extends BaseGameObject.derive(ObjectCategory.Player) {
    ...
    set sizeMod(size: number) {
        ...
        this._sizeMod = size;
        this._hitbox = Actor.baseHitbox.transform(this._hitbox.position, size);
    ...
    constructor(game: Game, socket: WebSocket<PlayerContainer>, position: Vector, layer?: Layer, team?: Team) {
        ...
        this._hitbox = Actor.baseHitbox.transform(position);
    ...
    postPacket(): void {
        for (const key in this.dirty) {
            this.dirty[key as keyof Actor["dirty"]] = false;
        }
    ...
    piercingDamage(params: DamageParams): void {
        ...
        const sourceIsPlayer = source instanceof Actor;
    ...
    die(params: Omit<DamageParams, "amount">): void {
        ...
        if (
            ...
            const attributeToPlayer = (player: Actor, item: InventoryItem | null = player.activeItem): void => {
                (
    ...
    teamWipe(): void {
        ...
        let players: readonly Actor[] | undefined;
    ...
    canInteract(player: Actor): boolean {
            ...
            switch (type) {
                ...
                case InputActions.Interact: {
                    interface CloseObject {
                        object: Obstacle | Actor | Loot | undefined
                        dist: number
                    }
